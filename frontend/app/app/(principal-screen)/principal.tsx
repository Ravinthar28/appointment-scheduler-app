...
export default function WelcomeScreen() {
  return (
    <LinearGradient
      // These colors are an approximation based on the image. You might need to adjust them
      // to perfectly match the gradient in your design.
      colors={['#2D3F75', '#3A508C', '#5C7FB7', '#7D9DCF']} // Example gradient colors from dark blue to lighter blue/purple
